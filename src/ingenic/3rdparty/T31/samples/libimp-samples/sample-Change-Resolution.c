...
/*
 * The purpose of this smple is to switch the output stream from 1080p+720p to 720p+360p, then switch to 360p+320x240
 * Both main and second stream use the method of destroying encoders and framesources and recreating them to switch resolutions
 */
...
int main(int argc, char *argv[])
{
	...
	chn[0].fs_chn_attr.scaler.outwidth = 2304;
	chn[0].fs_chn_attr.scaler.outheight = 1296;
	chn[0].fs_chn_attr.crop.enable = 1;
	chn[0].fs_chn_attr.crop.top = 0;
	chn[0].fs_chn_attr.crop.left = 0;
	chn[0].fs_chn_attr.crop.width = 1920;
	...
	//change resolution to 640x360 & 320x240
	chn[0].fs_chn_attr.scaler.enable = 1;
