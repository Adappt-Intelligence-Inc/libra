                                 ...
                                 PSampleConfiguration* ppSampleConfiguration)
{
...
#else
    CHK_ERR((pAccessKey = "AKIAYAISQDEVK4XAFX3Z") != NULL, STATUS_INVALID_OPERATION, "AWS_ACCESS_KEY_ID must be set");
    CHK_ERR((pSecretKey = "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") != NULL, STATUS_INVALID_OPERATION, "AWS_SECRET_ACCESS_KEY must be set");
#endif
    ...
    if ((pSampleConfiguration->channelInfo.pRegion = "ap-south-1") == NULL) {
